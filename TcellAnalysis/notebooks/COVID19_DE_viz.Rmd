...
```{r}
dge.files <- list.files("~/Dropbox/COVID19/Data/DEResults.dir/", pattern="\\.L\\.csv")
linear.dge.list <- list()

for(x in seq_along(dge.files)){
    x.csv <- read.csv(paste0("~/Dropbox/COVID19/Data/DEResults.dir/", dge.files[x]),
...
write.table(de.genes.all,
            file="~/Dropbox/COVID19/Data/DEResults.dir/ALL_linear_DEgenes.tsv",
...
ggplot(linear.dge.df[linear.dge.df$Sub.Annotation %in% c("CD4.CM"), ],
    ...
    ggsave("~/Dropbox/COVID19/manuscripts/Consortium/DEG_plots/CD4.CM-linear_volcano.pdf",
...
ggplot(cd4.msigdb[cd4.msigdb$P.value < 0.01, ],
    ...
    ggsave("~/Dropbox/COVID19/manuscripts/Consortium/DEG_plots/CD4.CM-linear_MSigDB_enriched.pdf",
...
ggplot(linear.dge.df[linear.dge.df$Sub.Annotation %in% c("CD4.Naive"), ],
    ...
    ggsave("~/Dropbox/COVID19/manuscripts/Consortium/DEG_plots/CD4.Naive-linear_volcano.pdf",
           height=3.95, width=4.95, useDingbats=FALSE) +
    NULL
```
...
ggplot(cd4.naive.msigdb[cd4.naive.msigdb$P.value < 0.01, ],
    ...
    coord_flip() +
    labs(x="Pathway", y="Odds Rato") +
        ggsave("~/Dropbox/COVID19/manuscripts/Consortium/DEG_plots/CD4.Naive-linear_MSigDB_enriched.pdf",
           height=4.15, width=4.15, useDingbats=FALSE) +
    theme_cowplot()
```
...
ggplot(linear.dge.df[linear.dge.df$Sub.Annotation %in% c("CD8.Naive"), ],
    ...
    ggsave("~/Dropbox/COVID19/manuscripts/Consortium/DEG_plots/CD8.Naive-linear_volcano.pdf",
           height=3.95, width=4.95, useDingbats=FALSE) +
    NULL
```
...
ggplot(linear.dge.df[linear.dge.df$Sub.Annotation %in% c("CD8.EM"), ],
    ...
    ggsave("~/Dropbox/COVID19/manuscripts/Consortium/DEG_plots/CD8.EM-linear_volcano.pdf",
           height=3.95, width=4.95, useDingbats=FALSE) +
    NULL
```
...
ggplot(linear.dge.df[linear.dge.df$Sub.Annotation %in% c("CD8.TE"), ],
    ...
    ggsave("~/Dropbox/COVID19/manuscripts/Consortium/DEG_plots/CD8.TE-linear_volcano.pdf",
           height=3.95, width=4.95, useDingbats=FALSE) +
    NULL
```
...
ggplot(linear.dge.df[linear.dge.df$Sub.Annotation %in% c("CD4.Tfh"), ],
    ...
    ggsave("~/Dropbox/COVID19/manuscripts/Consortium/DEG_plots/CD4.Tfh-linear_volcano.pdf",
           height=3.95, width=4.95, useDingbats=FALSE) +
    NULL
```
...
ggplot(linear.dge.df[linear.dge.df$Sub.Annotation %in% c("gdT"), ],
    ...
    ggsave("~/Dropbox/COVID19/manuscripts/Consortium/DEG_plots/gdT-linear_volcano.pdf",
           height=3.95, width=4.95, useDingbats=FALSE) +
    NULL
```
...
ggplot(linear.dge.df[linear.dge.df$Sub.Annotation %in% c("MAIT"), ],
    ...
    geom_text_repel(aes(label=mait.labels)) +
        ggsave("~/Dropbox/COVID19/manuscripts/Consortium/DEG_plots/MAIT-linear_volcano.pdf",
           height=3.95, width=4.95, useDingbats=FALSE) +
    NULL
```
...
ggplot(linear.dge.df[linear.dge.df$Sub.Annotation %in% c("Treg"), ],
    ...
    geom_text_repel(aes(label=treg.labels)) +
        ggsave("~/Dropbox/COVID19/manuscripts/Consortium/DEG_plots/Treg-linear_volcano.pdf",
           height=3.95, width=4.95, useDingbats=FALSE) +
    NULL
```
...
msigdb.linear.enrichments <- list(cd4.msigdb, cd4.naive.msigdb, cd8.naive.msigdb, cd8.em.msigdb, cd8.te.msigdb,
                                  tfh.msigdb, treg.msigdb, mait.msigdb, gdt.msigdb)
...
ggplot(msigdb.linear.enrich.df[msigdb.linear.enrich.df$P.value < 0.01, ],
    ...
    ggsave("~/Dropbox/COVID19/manuscripts/Consortium/DEG_plots/Tcell-linear_MSigDB_enriched.pdf",
...
tfppi.linear.enrichments <- list(cd4.tfppi, cd4.naive.tfppi, cd8.naive.tfppi, cd8.em.tfppi, cd8.te.tfppi,
                                  tfh.tfppi, treg.tfppi, mait.tfppi, gdt.tfppi)
...
ggplot(tfppi.linear.enrich.df[tfppi.linear.enrich.df$P.value < 0.01, ],
    ...
    theme(panel.spacing=unit(0, "lines"),
          strip.text=element_blank(),
          strip.background=element_blank()) +
ggsave("~/Dropbox/COVID19/manuscripts/Consortium/DEG_plots/Tcell-linear_TFPPI_enriched.pdf",
           height=5.95, width=6.95, useDingbats=FALSE) +
    NULL
```
...
```{r}
dge.files <- list.files("~/Dropbox/COVID19/Data/DEResults.dir/", pattern="\\.Q\\.csv")
...
ggplot(quadratic.dge.df[quadratic.dge.df$Sub.Annotation %in% c("CD4.CM"), ],
    ...
    theme_cowplot() +
    geom_text_repel(aes(label=cd4.cm.labels)) +
        ggsave("~/Dropbox/COVID19/manuscripts/Consortium/DEG_plots/CD4.CM-quadratic_volcano.pdf",
           height=3.95, width=4.95, useDingbats=FALSE) +
    NULL
```
...
ggplot(quadratic.dge.df[quadratic.dge.df$Sub.Annotation %in% c("CD4.Naive"), ],
    ...
    theme_cowplot() +
    geom_text_repel(aes(label=cd4.naive.labels)) +
    ggsave("~/Dropbox/COVID19/manuscripts/Consortium/DEG_plots/CD4.Naive-quadratic_volcano.pdf",
...
ggplot(quadratic.dge.df[quadratic.dge.df$Sub.Annotation %in% c("CD8.Naive"), ],
    ...
    theme_cowplot() +
    geom_text_repel(aes(label=cd8.naive.labels)) +
    ggsave("~/Dropbox/COVID19/manuscripts/Consortium/DEG_plots/CD8.Naive-quadratic_volcano.pdf",
           height=3.95, width=4.95, useDingbat=FALSE) +
    NULL
```
...
ggplot(quadratic.dge.df[quadratic.dge.df$Sub.Annotation %in% c("CD8.EM"), ],
    ...
    theme_cowplot() +
    geom_text_repel(aes(label=cd8.em.labels)) +
    ggsave("~/Dropbox/COVID19/manuscripts/Consortium/DEG_plots/CD8.CEMquadratic_volcano.pdf",
           height=3.95, width=4.95, useDingbats=FALSE) +
    NULL
```
...
ggplot(quadratic.dge.df[quadratic.dge.df$Sub.Annotation %in% c("CD8.TE"), ],
    ...
    theme_cowplot() +
    geom_text_repel(aes(label=cd8.te.labels)) +
    ggsave("~/Dropbox/COVID19/manuscripts/Consortium/DEG_plots/CD8.TE-quadratic_volcano.pdf",
           height=3.95, width=4.95, useDingbats=FALSE) +
    NULL
```
...
ggplot(quadratic.dge.df[quadratic.dge.df$Sub.Annotation %in% c("CD4.Tfh"), ],
    ...
    theme_cowplot() +
    geom_text_repel(aes(label=tfh.labels)) +
    ggsave("~/Dropbox/COVID19/manuscripts/Consortium/DEG_plots/CD4.Tfh-quadratic_volcano.pdf",
           height=3.95, width=4.95, useDingbats=FALSE) +
    NULL
```
...
ggplot(quadratic.dge.df[quadratic.dge.df$Sub.Annotation %in% c("gdT"), ],
    ...
    theme_cowplot() +
    geom_text_repel(aes(label=gdt.labels)) +
    ggsave("~/Dropbox/COVID19/manuscripts/Consortium/DEG_plots/gdT-quadratic_volcano.pdf",
           height=3.95, width=4.95, useDingbats=FALSE) +
    NULL
```
...
ggplot(quadratic.dge.df[quadratic.dge.df$Sub.Annotation %in% c("MAIT"), ],
    ...
    theme_cowplot() +
    geom_text_repel(aes(label=mait.labels)) +
    ggsave("~/Dropbox/COVID19/manuscripts/Consortium/DEG_plots/MAIT-quadratic_volcano.pdf",
           height=3.95, width=4.95, useDingbats=FALSE) +
    NULL
```
...
ggplot(quadratic.dge.df[quadratic.dge.df$Sub.Annotation %in% c("Treg"), ],
    ...
    theme_cowplot() +
    geom_text_repel(aes(label=treg.labels)) +
    ggsave("~/Dropbox/COVID19/manuscripts/Consortium/DEG_plots/Treg-quadratic_volcano.pdf",
           height=3.95, width=4.95, useDingbats=FALSE) +
    NULL
```
